...
class RejectedScreen extends StatefulWidget {
  ...
  var empCode;
  RejectedScreen({super.key, required this.formDate, required this.toDate});

  @override
  State<RejectedScreen> createState() => _PendingPageState();
}

class _PendingPageState extends State<RejectedScreen> {
  var result,msg;
