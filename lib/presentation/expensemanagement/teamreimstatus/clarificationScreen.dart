...
class ClarificationScreen extends StatefulWidget {
  ...
  var empCode;
  ClarificationScreen({super.key, required this.formDate, required this.toDate});

  @override
  State<ClarificationScreen> createState() => _PendingPageState();
}

class _PendingPageState extends State<ClarificationScreen> {
  var result,msg;
  ...
  void initState() {
    ...
    print("------33----empCode---${widget.empCode}");
    print("------32----C---");
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        "Applied At: ${policyDocData.dApplyDate}", // Example text
