                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: Text("Change Password", style: AppTextStyle.font14OpenSansRegularWhiteTextStyle,
                          ),
                        ),
                      ),
                      SizedBox(height: 10),
                                        ...
                                        onTap: () async {
                                          ...
                                          if(_formKey.currentState!.validate() && oldPassword.isNotEmpty && newPassword.isNotEmpty && confirmPassword.isNotEmpty){
                                            ...
                                            if(newPassword==confirmPassword){
                                              print("--Call Api---");
                                              /// todo here is a call api to commet in a feature

                                              loginMap = await ChangePasswordRepo2().changePasswrod2(context, oldPassword!,newPassword);
                                              print('---358----$loginMap');
                                              result = "${loginMap[0]['Result']}".toString();
                                              msg = "${loginMap[0]['Msg']}".toString();
                                              print('---361----$result');
                                              print('---362----$msg');
                                             // displayToast(msg);
