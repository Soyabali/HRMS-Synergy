...
class AllPage extends StatefulWidget {
  ...
  var result,msg;
  AllPage({super.key, required this.formDate, required this.toDate});
...
class _AllPageState extends State<AllPage> {
  ...
  void initState() {
    ...
    hrmsLeaveStatus = HrmsLeaveStatusRepo()
        .hrmsLeveStatusList(context, "${widget.formDate}", "${widget.toDate}","A");
                                                ...
                                                children: [
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      SizedBox(width: 5),
                                                      Text(
                                                        '${policyDocData.sLeaveStatus} : ${policyDocData.dAppRejDate}',
                                                        style: AppTextStyle.font12OpenSansRegularBlackTextStyle,
                                                      ),
                                                    ],
                                                  ),
                ...
                InkWell(
                  onTap: ()async{
                    ...
                    if(result=="1"){
                      ...
                      /// calla api again
                      hrmsLeaveStatus = HrmsLeaveStatusRepo().hrmsLeveStatusList(context, "${widget.formDate}", "${widget.toDate}","A");
